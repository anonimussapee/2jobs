...
const CardPost = (props) => {
  ...
  return (<div className='w-[90%] min-w-[300px] max-w-[620px] h-auto flex flex-col gap-5 items-start'>
    ...
    <div className='btn-container w-[100%] '>
       ...
       <button className='btn-card hover:bg-gray-400  bg-gray-500 text-white rounded-xl'>Observar oferta</button>
       <button className='btn-card hover:bg-gray-400  bg-gray-500 text-white rounded-xl'>Compartir</button>
       <button className='btn-card hover:bg-gray-400  bg-gray-500 text-white rounded-xl'>Ofertas similares</button> 
    </div>
