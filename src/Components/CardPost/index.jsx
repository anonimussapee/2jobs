...
const CardPost = (props) => {
  ...
  return (<div className='w-[90%] min-w-[300px] max-w-[620px] h-auto flex flex-col gap-5 items-start'>
    ...
    <p className='font-light'>Fecha de publicación {formattedDate|| '1 de julio 2023'}</p>
    ...
    <p className='w-[90%] min-w-[280px] max-w-[600px] h-auto px-5 font-bold'>Contenido de la Oferta</p>
    <p className='w-[90%] min-w-[280px] max-w-[600px] h-auto pb-5 px-5'>{props.offer}</p>
    ...
    <div className='w-[100%] h-1 bg-gray-400'>   
